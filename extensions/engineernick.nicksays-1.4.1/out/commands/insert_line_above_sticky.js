...
exports.insert_line_above_sticky = void 0;
/**
...
*/
function insert_line_above_sticky(editor, edit, ...args) {
...
exports.insert_line_above_sticky = insert_line_above_sticky;
function split_by_selections(text, selections) {
    const segments = [];
    let lastEnd = 0;
...
//# sourceMappingURL=insert_line_above_sticky.js.map