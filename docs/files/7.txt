JAV Writing System [
	...
	Recall and Find [
		...
		Fuzzy search within file and across files. [
			Results appear immediately in separate, filterable view. Keyboard-driven—no mode switching for quick recall.
		]
		Glossary search by name and definitions [
			• Search "sword brok".
				•  System finds "sword broken", "broke his sword".
			• Tag categories instead of remembering names or using folders/multiple files.
				• Retrieve characters/places/ideas by association.
			• Immediately find what you want
					• Don't lose focus
